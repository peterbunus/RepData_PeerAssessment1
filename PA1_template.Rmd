...
```
The `r index_max_steps_average`th 5-minutes interval contains the maximum number of steps
...
```
A number of `r no_missing_val` values are missing
...
```
A number of `r count` missing values have been replaced
...
The mean number of steps taken per day is `r mean_steps_filled`. The previously calculated mean number of steps taken per day was `r mean_steps`
...
The median number of steps taken per day is `r median_steps_filled`. The previously calcultaed median number of steps taken per day was `r median_steps`
